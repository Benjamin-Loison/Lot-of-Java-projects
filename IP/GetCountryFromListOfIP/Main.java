...
public class Main
{
    static final String LINE_CONTAINS = "<tr><th>Country:</th><td>";
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            {
                String requestThread = "https://whatismyipaddress.com/ip/" + ips.get(ipIndex);
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            while((line = in.readLine()) != null)
                            {
                                ...
                                {
                                    String isp = line.replace(LINE_CONTAINS, "").replace(" <img src=\"//cdn.whatismyipaddress.com/images/flags/fr.png\" alt=\"fr flag\"> </td></tr>", "");
