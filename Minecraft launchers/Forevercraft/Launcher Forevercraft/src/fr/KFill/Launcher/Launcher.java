...
public class Launcher
{
    ...
    public static final GameInfos LC_INFOS = new GameInfos("Forevercraft", LC_VERSION, new GameTweak[] {GameTweak.FORGE});
    ...
    {
        SUpdate su = new SUpdate("http://altiscraft.fr/BEN/Forevercraft/Supdate/", LC_DIR);
