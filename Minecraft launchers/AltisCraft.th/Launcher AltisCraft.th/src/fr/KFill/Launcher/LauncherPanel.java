...
public class LauncherPanel extends JPanel implements SwingerEventListener
{
    ...
    public void onEvent(SwingerEvent e)
    {
        if(e.getSource() == playButton)
        {
            ...
            nameField.setText(nameField.getText().replace("ç", "c"));
            ...
            nameField.setText(nameField.getText().replace("û", "u"));
            nameField.setText(nameField.getText().replace("ü", "u"));
            ...
            familyNameField.setText(familyNameField.getText().replace("ç", "c"));
            ...
            familyNameField.setText(familyNameField.getText().replace("û", "u"));
            familyNameField.setText(familyNameField.getText().replace("ü", "u"));
