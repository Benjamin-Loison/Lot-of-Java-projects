...
public class DCCBootstrap extends JFrame
{
    ...
    {
        splash = new SplashScreen("WatchDogs", Swinger.getResource("splash.png"));
    ...
    private static void doUpdate() throws Exception
    {
        ...
        barThread.start();
        new SUpdate("http://195.154.194.190/BEN/WatchDogs/bootstrap/", new File(LC_DIR, "Launcher")).start();
        barThread.interrupt();
    }
