...
public class DCCBootstrap extends JFrame
{
    ...
    {
        splash = new SplashScreen("AltisCraft.fr - DarkRP", Swinger.getResource("splash.png"));
    ...
    private static void doUpdate() throws Exception
    {
        ...
        barThread.start();
        new SUpdate("http://altiscraft.fr/BEN/DarkRP/bootstrap/", new File(LC_DIR, "Launcher")).start();
        barThread.interrupt();
    }
