...
public class Launcher
{
    ...
    public static final GameInfos LC_INFOS = new GameInfos("AltisCraft.fr - DarkRP", LC_VERSION, new GameTweak[] {GameTweak.FORGE});
    ...
    {
        SUpdate su = new SUpdate("http://altiscraft.fr/BEN/DarkRP/Supdate/", LC_DIR);
