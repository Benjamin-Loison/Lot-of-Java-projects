...
public class ItemBullet extends ItemShootable implements IFlanItem {
	...
	public EntityShootable getEntity(World worldObj, Vec3 origin, float yaw, float pitch, double motionX,
			...
			InfoType shotFrom) {
		return new EntityBullet(worldObj, origin, yaw, pitch, motionX, motionY, motionZ, shooter, gunDamage, this.type,
				shotFrom);
	}

	// Can be overriden to allow new types of bullets to be created, vector
	// constructor
	...
	// Can be overriden to allow new types of bullets to be created, AA/MG
	// constructor
	...
	// Can be overriden to allow new types of bullets to be created, Handheld
	// constructor
