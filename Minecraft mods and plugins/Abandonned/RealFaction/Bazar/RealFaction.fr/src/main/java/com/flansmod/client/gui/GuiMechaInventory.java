...
public class GuiMechaInventory extends GuiContainer
{
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y)
    {
        ...
        fontRendererObj.drawString("Inventaire", 181, (ySize - 96) + 2, 0x404040);
    }
	...
	{
		super.initGui();
		buttonList.add(new GuiButton(0, width / 2 - 166, height / 2 + 63, 93, 20, "a.p"));
		buttonList.add(new GuiButton(1, width / 2 - 68, height / 2 + 63, 68, 20, "f.repa"));
	}
