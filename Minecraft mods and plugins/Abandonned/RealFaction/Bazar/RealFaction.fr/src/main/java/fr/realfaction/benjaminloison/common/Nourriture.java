...
import net.minecraft.potion.PotionEffect;
 ...
 public class Nourriture extends ItemFood
 {
   private PotionEffect[] effects;
   
   public Nourriture(String unlocalizedName, int healAmount, float saturationModifier, boolean wolvesFavorite, PotionEffect... effects)
   {
