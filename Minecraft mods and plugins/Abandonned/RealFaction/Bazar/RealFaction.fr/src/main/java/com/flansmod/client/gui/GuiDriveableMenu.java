...
public class GuiDriveableMenu extends GuiContainer
{
	...
	public void initGui()
	{
		...
		//Cargo button
		GuiButton cargoButton = new GuiButton(0, width / 2 - 60, height / 2 - 71, 58, 20, "Cargaison");
		cargoButton.enabled = type.numCargoSlots > 0;
		buttonList.add(cargoButton);
		
		//Gun button
		GuiButton gunsButton = new GuiButton(1, width / 2 + 2, height / 2 - 71, 58, 20, "Armes");
		gunsButton.enabled = type.ammoSlots() > 0;
		buttonList.add(gunsButton);
		
		//Fuel button
		GuiButton fuelButton = new GuiButton(2, width / 2 -60, height / 2 - 49, 58, 20, "Essence");
		...
		//Repair button
		buttonList.add(new GuiButton(4, width / 2 - 60, height / 2 - 27, 58, 20, "f.repa"));
	}
	...
	protected void drawGuiContainerForegroundLayer(int i, int j)
    {
        ...
        fontRendererObj.drawString("Inventaire", 8, (ySize - 96) + 2, 0x404040);
    }
