...
public class StuffCeintureBouftouRoyal
  extends Item
{
  public void addInformation(ItemStack stack, EntityPlayer player, List par3List, boolean par4)
  {
    par3List.add("§7Â§oElle est si douce qu'elle permet mÃªme de");
    par3List.add("§7Â§oligoter sa dulcinÃ©e lorsque celle-ci");
    par3List.add("§7Â§orefuse de rester Ã  la maison.");
    par3List.add("");
