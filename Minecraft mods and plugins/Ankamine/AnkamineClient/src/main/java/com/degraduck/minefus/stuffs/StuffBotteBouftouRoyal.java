...
public class StuffBotteBouftouRoyal
  extends Item
{
  public void addInformation(ItemStack stack, EntityPlayer player, List par3List, boolean par4)
  {
    par3List.add("§7Â§oElles brillent, elles respirent la");
    par3List.add("§7Â§opuissance, ces bottes sont en tous");
    par3List.add("§7Â§opoints royales.");
    par3List.add("");
