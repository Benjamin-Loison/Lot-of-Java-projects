...
public class StuffCeintureBouftou
  extends Item
{
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
  {
    if (slot == 18) {
      return "moddofus:textures/models/armor/stuff_ceinture_bouftou.png";
    }
  ...
  {
    par3List.add("§7Â§oCette ceinture est ridiculement");
    par3List.add("§7Â§oridicule...");
