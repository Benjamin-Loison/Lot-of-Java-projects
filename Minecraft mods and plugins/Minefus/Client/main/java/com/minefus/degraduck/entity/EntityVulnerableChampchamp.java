...
public class EntityVulnerableChampchamp extends EntityMob
{
    public int mobSizeGen;

    public EntityVulnerableChampchamp(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.vulnerable_champ_champ.name"));
        setSize(0.7F, 0.7F);
    }
