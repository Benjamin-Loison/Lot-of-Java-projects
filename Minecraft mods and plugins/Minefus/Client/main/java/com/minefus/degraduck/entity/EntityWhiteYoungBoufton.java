...
public class EntityWhiteYoungBoufton extends EntityMob
{
    public int mobSizeGen;

    public EntityWhiteYoungBoufton(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.white_young_boufton.name"));
        setSize(0.6F, 0.6F);
    }
