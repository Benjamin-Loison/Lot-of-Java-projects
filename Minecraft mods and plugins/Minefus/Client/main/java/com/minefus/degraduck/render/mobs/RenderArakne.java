...
public class RenderArakne extends RenderLiving
{
    private static final ResourceLocation texture = new ResourceLocation(Minefus.MODID + ":textures/entity/Arakne.png");

    public RenderArakne(ModelBase model, float f)
    {
        super(model, f);
    }

    protected ResourceLocation getEntityTexture(EntityArakne entity)
    {
        return texture;
    }
    ...
    {
        return getEntityTexture((EntityArakne)entity);
    }

    protected void preRenderCallback(EntityLivingBase entity, float f)
    {
        scaleMobArakne((EntityArakne)entity, f);
    }

    protected void scaleMobArakne(EntityArakne entity, float f)
    {
