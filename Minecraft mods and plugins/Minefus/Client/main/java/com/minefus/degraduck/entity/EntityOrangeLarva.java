...
public class EntityOrangeLarva extends EntityMob
{
    public int mobSizeGen;

    public EntityOrangeLarva(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.orange_larva.name"));
        setSize(0.5F, 0.5F);
    }
    ...
    public void applyEntityAttributes()
    {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(13);
    ...
    {
        return Minefus.MODID + ":Larve death";
    }
