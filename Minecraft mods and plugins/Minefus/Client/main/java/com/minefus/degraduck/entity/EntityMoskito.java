...
public class EntityMoskito extends EntityMob
{
    public int mobSizeGen;

    public EntityMoskito(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.moskito.name"));
        setSize(0.6F, 0.6F);
    }
    ...
    public void applyEntityAttributes()
    {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(11);
