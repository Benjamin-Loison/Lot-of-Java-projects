...
import com.minefus.degraduck.models.items.ModelRoyalBouftouHelmet;
...
public class RoyalBouftouHelmet extends ItemArmor
{
    ...
    public RoyalBouftouHelmet()
    {
        ...
        setTextureName(Minefus.MODID + ":Royal bouftou helmet");
    ...
    {
        if(slot == 0)
            return Minefus.MODID + ":textures/models/armor/Royal bouftou helmet.png";
    ...
    {
        if(stack.getItem() == Minefus.royalBouftouHelmet)
            return new ModelRoyalBouftouHelmet(armor);
        return null;
    }

    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean b)
    {
        list.add("§7Â§oLa Boufcoiffe Royale est un objet");
        list.add("§7Â§oindémodable.");
        list.add("");
