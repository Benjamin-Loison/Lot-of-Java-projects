...
public class CustomInvisibleButton extends GuiButton
{
    protected static final ResourceLocation buttonTextures = new ResourceLocation(PhoneGui.MODID, "textures/gui/Widgets 0.png");

    public CustomInvisibleButton(int id, int xPosition, int yPosition, String name, int x, int y)
    {
