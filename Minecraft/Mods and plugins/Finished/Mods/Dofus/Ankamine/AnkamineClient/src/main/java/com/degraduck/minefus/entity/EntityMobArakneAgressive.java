...
public class EntityMobArakneAgressive
  extends EntityMob
{
  public int mobSizeGen;
  
  public EntityMobArakneAgressive(World world)
  {
    super(world);
    mobSizeGen = ((int)Math.round(Math.random() * 5.0D));
    setCustomNameTag("Arakne Agressive");
    setSize(0.6F, 0.6F);
  }
  ...
  {
    EntityPlayer entityplayer = worldObj.getClosestVulnerablePlayerToEntity(this, 4.0D);
