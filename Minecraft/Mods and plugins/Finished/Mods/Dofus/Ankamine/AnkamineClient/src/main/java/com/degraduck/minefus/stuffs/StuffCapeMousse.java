...
import com.degraduck.minefus.models.items.ModelCapeMousse;
...
public class StuffCapeMousse
  extends ItemArmor
{
  private ModelBase value;
  
  public StuffCapeMousse(ItemArmor.ArmorMaterial material, int type)
  {
  ...
  {
    if (slot == 1) {
      return "moddofus:textures/models/armor/stuff_cape_mousse.png";
    }
  ...
  {
    if (stack.getItem() == Dofus.StuffCapeMousse) {
      return new ModelCapeMousse(armor);
    }
    return null;
  }
