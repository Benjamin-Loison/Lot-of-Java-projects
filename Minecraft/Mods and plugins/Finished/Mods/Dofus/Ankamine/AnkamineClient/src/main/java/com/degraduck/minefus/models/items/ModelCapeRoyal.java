  ...
  extends ModelBiped
{
  ...
  public ModelCapeRoyal(float f)
  {
    ...
    Shape9 = new ModelRenderer(this, 38, 58);
    ...
    Shape15 = new ModelRenderer(this, 34, 46);
    Shape15.addBox(1.0F, 15.0F, -6.5F, 1, 1, 1);
    Shape15.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape15.setTextureSize(64, 64);
    Shape15.mirror = true;
    setRotation(Shape15, 0.0F, 3.141593F, 0.0F);
    Shape16 = new ModelRenderer(this, 34, 46);
    Shape16.addBox(2.0F, 14.1F, -6.5F, 1, 1, 1);
    Shape16.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape16.setTextureSize(64, 64);
    Shape16.mirror = true;
    setRotation(Shape16, 0.0F, 3.141593F, 0.0F);
    Shape17 = new ModelRenderer(this, 34, 46);
    Shape17.addBox(3.0F, 15.0F, -6.5F, 1, 2, 1);
    Shape17.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape17.setTextureSize(64, 64);
    Shape17.mirror = true;
    setRotation(Shape17, 0.0F, 3.141593F, 0.0F);
    Shape18 = new ModelRenderer(this, 34, 46);
    Shape18.addBox(1.0F, 17.0F, -6.5F, 2, 1, 1);
    Shape18.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape18.setTextureSize(64, 64);
    Shape18.mirror = true;
    setRotation(Shape18, 0.0F, 3.141593F, 0.0F);
    Shape19 = new ModelRenderer(this, 34, 46);
    Shape19.addBox(-3.0F, 14.1F, -6.5F, 1, 1, 1);
    Shape19.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape19.setTextureSize(64, 64);
    Shape19.mirror = true;
    setRotation(Shape19, 0.0F, 3.141593F, 0.0F);
    Shape20 = new ModelRenderer(this, 34, 46);
    Shape20.addBox(-2.0F, 15.0F, -6.5F, 1, 1, 1);
    Shape20.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape20.setTextureSize(64, 64);
    Shape20.mirror = true;
    setRotation(Shape20, 0.0F, 3.141593F, 0.0F);
    Shape21 = new ModelRenderer(this, 34, 46);
    Shape21.addBox(-4.0F, 15.0F, -6.5F, 1, 2, 1);
    Shape21.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape21.setTextureSize(64, 64);
    Shape21.mirror = true;
    setRotation(Shape21, 0.0F, 3.141593F, 0.0F);
    Shape22 = new ModelRenderer(this, 34, 46);
    Shape22.addBox(-3.0F, 17.0F, 5.5F, 2, 1, 1);
    Shape22.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape22.setTextureSize(64, 64);
    Shape22.mirror = true;
    setRotation(Shape22, 0.0F, 0.0F, 0.0F);
    Shape23 = new ModelRenderer(this, 34, 45);
    Shape23.addBox(2.0F, 20.0F, -8.0F, 1, 3, 1);
    Shape23.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape23.setTextureSize(64, 64);
    Shape23.mirror = true;
    setRotation(Shape23, 0.0F, 3.141593F, 0.0F);
    Shape24 = new ModelRenderer(this, 34, 45);
    Shape24.addBox(-3.0F, 20.0F, -8.0F, 1, 3, 1);
    Shape24.setRotationPoint(0.0F, 0.0F, 0.0F);
    Shape24.setTextureSize(64, 64);
    Shape24.mirror = true;
    setRotation(Shape24, 0.0F, 3.141593F, 0.0F);
  }
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
  {
    ...
    Shape17.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape18.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape19.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape20.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape21.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape22.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape23.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
    Shape24.rotateAngleX = (MathHelper.cos(f2 * 0.1F) / 25.0F - f1 / 2.0F - 0.1F);
  }
}
