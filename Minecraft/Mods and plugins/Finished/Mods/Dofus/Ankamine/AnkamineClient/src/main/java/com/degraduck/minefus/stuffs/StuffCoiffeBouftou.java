...
import com.degraduck.minefus.models.items.ModelCoiffeBouftou;
...
public class StuffCoiffeBouftou
  extends ItemArmor
{
  private ModelBase value;
  
  public StuffCoiffeBouftou(ItemArmor.ArmorMaterial material, int type)
  {
  ...
  {
    if (slot == 0) {
      return "moddofus:textures/models/armor/stuff_coiffe_bouftou.png";
    }
  ...
  {
    if (stack.getItem() == Dofus.StuffCoiffeBouftou) {
      return new ModelCoiffeBouftou(armor);
    }
    return null;
  }
  ...
  {
    par3List.add("§7Â§oLes yeux bougent encore...");
