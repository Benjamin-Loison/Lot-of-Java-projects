...
public class MinefusContainerPlayer extends Container
{
    ...
    private void bindMinefusInventory(MinefusInventoryPlayer inventoryMinefus)
    {
        ...
        addSlotToContainer(new SlotRing(inventoryMinefus, 16, 28, 43));
        addSlotToContainer(new SlotRing(inventoryMinefus, 17, 118, 43));
        addSlotToContainer(new SlotBelt(inventoryMinefus, 18, 28, 61));
        addSlotToContainer(new SlotAmulet(inventoryMinefus, 19, 28, 7));
        addSlotToContainer(new SlotBoots(inventoryMinefus, 20, 28, 79));
    }
