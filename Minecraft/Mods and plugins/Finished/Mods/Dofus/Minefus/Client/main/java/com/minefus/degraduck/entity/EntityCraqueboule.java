...
public class EntityCraqueboule extends EntityMob
{
    public int mobSizeGen;

    public EntityCraqueboule(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.craqueboule.name"));
        setSize(1.25F, 1.25F);
    }
    ...
    public void applyEntityAttributes()
    {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(52);
    ...
    {
        return Minefus.MODID + ":Craqueboule hurt";
    }

    public String getDeathSound()
    {
        return Minefus.MODID + ":Craqueboule death";
    }

    public String getLivingSound()
    {
        return Minefus.MODID + ":Craqueboule living";
    }
