...
public class Minefus
{
    ...
    @SidedProxy(clientSide = "com.minefus.degraduck.proxy.ClientProxy", serverSide = "com.minefus.degraduck.proxy.CommonProxy")
    ...
    public static final String MODID = "minefus", NAME = "Minefus", VERSION = "1.0.0", ICONS[] = {"/assets/" + MODID + "/textures/gui/16.png", "/assets/" + MODID + "/textures/gui/32.png", "/assets/" + MODID + "/textures/gui/128.png"};;
    public static final PacketPipeline PACKET_PIPELINE = new PacketPipeline();
    public static CreativeTabs dofusTab = new CreativeTabs(MODID)
    {
    ...
    {
        //if(!Minecraft.getMinecraft().mcDataDir.getAbsolutePath().contains(NAME))
          //  Throwables.propagate(new Exception(I18n.format("launcher.non.authorized")));
        print("Pre-Initializing !");
        instance = this;
        if(!FileAPI.options.exists())
            FileAPI.write(FileAPI.options, "resourcePacks:[\"Minefus.zip\"]");
        ...
        doubleSlabStone = new BlockSlabStone(true, Material.rock, 2, 10, Block.soundTypeStone, "double_stone_slab");
        singleSlabStone = new BlockSlabStone(false, Material.rock, 2, 10, Block.soundTypeStone, "single_stone_slab");
        ...
        astrubPotion = new PotionMod("astrub_potion", "Astrub potion");
        bontaPotion = new PotionMod("bonta_potion", "Bonta potion");
