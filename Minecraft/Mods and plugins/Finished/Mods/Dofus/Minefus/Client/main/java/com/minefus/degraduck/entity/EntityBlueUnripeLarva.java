...
public class EntityBlueUnripeLarva extends EntityMob
{
    public int mobSizeGen;

    public EntityBlueUnripeLarva(World world)
    {
        super(world);
        mobSizeGen = ((int)Math.round(Math.random() * 5));
        setCustomNameTag(I18n.format("entity.blue_unripe_larva.name"));
        setSize(0.5F, 0.5F);
    }
