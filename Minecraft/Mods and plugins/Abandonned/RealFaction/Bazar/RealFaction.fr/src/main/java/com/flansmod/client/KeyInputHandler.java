...
{  
	...
	public static KeyBinding inventoryKey = new KeyBinding("inv.veh", Keyboard.KEY_R, "Flan's Mod");
	public static KeyBinding bombKey = new KeyBinding("Larguer une bombe", Keyboard.KEY_V, "Flan's Mod");
//	public static KeyBinding gunKey = new KeyBinding("tir.am", Keyboard.KEY_B, "Flan's Mod");
	public static KeyBinding controlSwitchKey = new KeyBinding("ac.ch", Keyboard.KEY_C, "Flan's Mod");
	public static KeyBinding reloadKey = new KeyBinding("Recharger", Keyboard.KEY_R, "Flan's Mod");
	public static KeyBinding teamsMenuKey = new KeyBinding("f.equ", Keyboard.KEY_G, "Flan's Mod");
	public static KeyBinding teamsScoresKey = new KeyBinding("Menu des scores", Keyboard.KEY_H, "Flan's Mod");
	public static KeyBinding leftRollKey = new KeyBinding("piv.g", Keyboard.KEY_Z, "Flan's Mod");
	public static KeyBinding rightRollKey = new KeyBinding("piv.d", Keyboard.KEY_X, "Flan's Mod");
    public static KeyBinding gearKey = new KeyBinding("Lever / Descendre les roues", Keyboard.KEY_L, "Flan's Mod");
    public static KeyBinding doorKey = new KeyBinding("Ouvrir / Fermer les portes", Keyboard.KEY_K, "Flan's Mod");
