...
public class ConteneurCraft extends Container
{
    ...
    public ConteneurCraft(InventoryPlayer p_i1808_1_, World p_i1808_2_, int p_i1808_3_, int p_i1808_4_, int p_i1808_5_)
    {
