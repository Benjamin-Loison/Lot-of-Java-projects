...
{
    public static final String NAME = "FPSCraft";
    public static final GameVersion LC_VERSION = new GameVersion("1.7.10", GameType.V1_7_10);
    public static final GameInfos LC_INFOS = new GameInfos(NAME, LC_VERSION, new GameTweak[] {GameTweak.FORGE});
    ...
    {
        SUpdate su = new SUpdate("http://altiscraft.fr/BEN/MCLauncherGenerator/Launchers/" + NAME + "/Supdate/", LC_DIR);
