...
public class DCCBootstrap extends JFrame
{
    ...
    {
        splash = new SplashScreen("UnionMinecraft", Swinger.getResource("splash.png"));
    ...
    private static void doUpdate() throws Exception
    {
        ...
        barThread.start();
        new SUpdate("http://altiscraft.fr/BEN/UnionMinecraft/bootstrap/", new File(LC_DIR, "Launcher")).start();
        barThread.interrupt();
    }
