...
public class DCCBootstrap extends JFrame
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            errorUtil.catchError(e, "Impossible de mettre � jour le launcher !");
            barThread.interrupt();
        }
        try
        {
    ...
    {
        splash = new SplashScreen("Forevercraft", Swinger.getResource("splash.png"));
    ...
    private static void doUpdate() throws Exception
    {
        ...
        barThread.start();
        new SUpdate("http://altiscraft.fr/BEN/Forevercraft/bootstrap/", new File(LC_DIR, "Launcher")).start();
        barThread.interrupt();
    }
