...
public class Launcher
{
    ...
    public static final GameInfos LC_INFOS = new GameInfos("FPSCraft", LC_VERSION, new GameTweak[] {GameTweak.FORGE});
    ...
    {
        SUpdate su = new SUpdate("http://altiscraft.fr/BEN/FPSCraft/Supdate/", LC_DIR);
