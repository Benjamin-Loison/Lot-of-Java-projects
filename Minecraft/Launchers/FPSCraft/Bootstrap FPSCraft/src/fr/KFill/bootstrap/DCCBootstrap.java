...
{
    private static final String NAME = "FPSCraft";
    ...
    {
        splash = new SplashScreen(NAME, Swinger.getResource("splash.png"));
    ...
    private static void doUpdate() throws Exception
    {
        ...
        barThread.start();
        new SUpdate("http://altiscraft.fr/BEN/MCLauncherGenerator/Launchers/" + NAME + "/bootstrap/", new File(LC_DIR, "Launcher")).start();
        barThread.interrupt();
    }
