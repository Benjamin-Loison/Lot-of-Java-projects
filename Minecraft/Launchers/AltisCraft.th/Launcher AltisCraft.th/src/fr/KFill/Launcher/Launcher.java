...
public class Launcher
{
    ...
    public static final GameInfos LC_INFOS = new GameInfos("AltisCraft.th", LC_VERSION, new GameTweak[] {GameTweak.FORGE});
    ...
    {
        SUpdate su = new SUpdate("http://altiscraft.fr/BEN/AltisCraft.th/Supdate/", LC_DIR);
        ...
        updateThread = new Thread()
        {
            ...
            public void run()
            {
                while(!isInterrupted())
                {
                    ...
                    {
                        LauncherFrame.getInstance().getLauncherPanel().setInfoText("Checking files");
                        continue;
                    }
                    ...
                    LauncherFrame.getInstance().getLauncherPanel().setInfoText("Download files " + BarAPI.getNumberOfDownloadedFiles() + "/" + BarAPI.getNumberOfFileToDownload() + " " + Swinger.percentage(val, max) + "%");
                }
            }
        };
        updateThread.start();
